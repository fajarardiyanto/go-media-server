...
func StreamConn(c *websocket.Conn, p *Peers) {
	...
	for _, v := range []webrtc.RTPCodecType{webrtc.RTPCodecTypeVideo, webrtc.RTPCodecTypeAudio} {
		if _, err = peerConnection.AddTransceiverFromKind(v, webrtc.RTPTransceiverInit{
